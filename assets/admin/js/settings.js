...
$(document).ready(function(){
    ...
    $(".theme-settings input").on("ifClicked",function(){
        ...
        if(input.attr("st_layout_boxed") != 'st_layout_boxed'){
                
            if(!input.prop("checked")){
                theme_settings[input.attr("st_layout_boxed")] = input.val();
            }else{            
                theme_settings[input.attr("st_layout_boxed")] = 0;
            }
        ...
        /* Rules */
        if(input.attr("st_layout_boxed") === 'st_sb_fixed'){
        ...
        if(input.attr("st_layout_boxed") === 'st_sb_scroll'){
        ...
        set_settings(theme_settings,input.attr("st_layout_boxed"));
    });
