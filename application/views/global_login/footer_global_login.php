 ...
 <!--
        ...
        <script src="<?php echo base_url(); ?>assets/login/assets/js/jquery.backstretch.min.js"></script>
        <script src="<?php echo base_url(); ?>assets/login/assets/js/scripts.js"></script>
        </body>
    </html>